...
<html class="no-js" lang="">
    <head>
		...
		<!-- pe-icon-7-stroke -->
		<link rel="stylesheet" href="resources/css/pe-icon-7-stroke.min.css">
		<!-- jquery-ui.min css -->
        <link rel="stylesheet" href="resources/css/jquery-ui.min.css">
        <!-- Image Zoom CSS
		============================================ -->
        <link rel="stylesheet" href="resources/css/img-zoom/jquery.simpleLens.css">
		<!-- meanmenu css -->
    ...
    <body>
                                                ...
                                                <div class="magamenu ">
                                                    <ul class="again">
                                                        ...
                                                        <li class="single-menu colmd4 colmd5">
                                                            <a href="#">
                                                                <img alt="" src="resources/img/maga-banner.png">
                                                            </a>
                                                        </li>
                                                    </ul>
                                                </div>
                                ...
                                <div class="right-header re-right-header">
                                    <ul>
                                        ...
                                        <li><a href="cart.html"><i class="fa fa-shopping-cart"></i><span class="color1">2</span></a>
                                            <ul class="drop-cart">
                                                <li>
                                                    <a href="cart.html"><img src="resources/img/cart/1.png" alt="" /></a>
                                                ...
                                                <li>
                                                    <a href="cart.html"><img src="resources/img/cart/2.png" alt="" /></a>
                                                    <div class="add-cart-text">
                                                        <p><a href="#">White Shirt</a></p>
                                                        <p>$50.00 x 2</p>
                                                        <span>Color : Blue</span>
            ...
            <div class="main-slider an-si">
                <div class="bend niceties preview-2 hm-ver-1">
                    <div id="ensign-nivoslider-2" class="slides">	
                        <img src="resources/img/slider/1.png" alt="" title="#slider-direction-3"  />
                        <img src="resources/img/slider/2.png" alt="" title="#slider-direction-1"  />
                    </div>
                    <!-- direction 1 -->
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="banner-box banner-box-re">
                                <a href="#">
                                    <img alt="" src="resources/img/banner/2.jpg">
                                    <div>
                                        <h2>
                                            Dynamic
                                            <span>Jazz</span>
                            ...
                            <div class="banner-box res-btm">
                                <a href="#">
                                    <img alt="" src="resources/img/banner/3.jpg">
                                    <div>
                                        <h2>
                                            Dynamic
                                            <span>Jazz</span>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="banner-container banner-box res-btm">
                                <a href="#">
                                    <img alt="" src="resources/img/banner/r6.png">
                                    <div>
                                        <h2>
                                            Dynamic
                                            <span>Jazz</span>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="banner-box banner-box-re">
                                <a href="#">
                                    <img alt="" src="resources/img/banner/4.jpg">
                                    <div>
                                        <h2>
                                            Dynamic
                                            <span>Jazz</span>
                            ...
                            <div class="banner-box">
                                <a href="#">
                                    <img alt="" src="resources/img/banner/5.jpg">
                                    <div>
                                        <h2>
                                            Dynamic
                                            <span>Jazz</span>
						...
						<div id="tab-carousel-1" class="re-owl-carousel owl-carousel product-slider owl-theme">
							<div class="col-xs-12">
								<div class="single-product">
                                    <div class="product-img">
                                        ...
                                        <a href="#">
                                            <img src="resources/img/products/1.jpg" alt="Product Title" />
                                            <img class="secondary-image" alt="Product Title" src="resources/img/products/2.jpg">
                                        </a>
                                    </div>
								...
								<div class="single-product margin-top">
                                    <div class="product-img">
                                        ...
                                        <a href="#">
                                            <img src="resources/img/products/3.jpg" alt="Product Title" />
                                            <img class="secondary-image" alt="Product Title" src="resources/img/products/4.jpg">
                                        </a>
                                    </div>
                                    <div class="product-dsc">
                                        <h3><a href="#">Product Title</a></h3>
							...
							<div class="col-xs-12">
								<div class="single-product">
                                    <div class="product-img">
                                        <a href="#">
                                            <img src="resources/img/products/5.jpg" alt="Product Title" />
                                            <img class="secondary-image" alt="Product Title" src="resources/img/products/6.jpg">
                                        </a>
                                    </div>
                                    <div class="product-dsc">
                                        <h3><a href="#">Product Title</a></h3>
								...
								<div class="single-product margin-top">
                                    <div class="product-img">
                                        <a href="#">
                                            <img src="resources/img/products/7.jpg" alt="Product Title" />
                                            <img class="secondary-image" alt="Product Title" src="resources/img/products/8.jpg">
                                        </a>
                                    </div>
                                    <div class="product-dsc">
                                        <h3><a href="#">Product Title</a></h3>
							...
							<div class="col-xs-12">
								<div class="single-product">
                                    <div class="product-img">
                                        <a href="#">
                                            <img src="resources/img/products/9.jpg" alt="Product Title" />
                                            <img class="secondary-image" alt="Product Title" src="resources/img/products/10.jpg">
                                        </a>
                                    </div>
                                    <div class="product-dsc">
                                        <h3><a href="#">Product Title</a></h3>
								...
								<div class="single-product margin-top">
                                    <div class="product-img">
                                        ...
                                        <a href="#">
                                            <img src="resources/img/products/14.jpg" alt="Product Title" />
                                            <img class="secondary-image" alt="Product Title" src="resources/img/products/12.jpg">
                                        </a>
                                    </div>
                                    <div class="product-dsc">
                                        <h3><a href="#">Product Title</a></h3>
							...
							<div class="col-xs-12">
								<div class="single-product">
                                    <div class="product-img">
                                        ...
                                        <a href="#">
                                            <img src="resources/img/products/15.jpg" alt="Product Title" />
                                            <img class="secondary-image" alt="Product Title" src="resources/img/products/14.jpg">
                                        </a>
                                    </div>
                                    <div class="product-dsc">
                                        <h3><a href="#">Product Title</a></h3>
								...
								<div class="single-product margin-top">
                                    <div class="product-img">
                                        ...
                                        <a href="#">
                                            <img src="resources/img/products/2.jpg" alt="Product Title" />
                                            <img class="secondary-image" alt="Product Title" src="resources/img/products/1.jpg">
                                        </a>
                                    </div>
                                    <div class="product-dsc">
                                        <h3><a href="#">Product Title</a></h3>
							...
							<div class="col-xs-12">
								<div class="single-product">
                                    <div class="product-img">
                                        <a href="#">
                                            <img src="resources/img/products/4.jpg" alt="Product Title" />
                                            <img class="secondary-image" alt="Product Title" src="resources/img/products/3.jpg">
                                        </a>
                                    </div>
                                    <div class="product-dsc">
                                        <h3><a href="#">Product Title</a></h3>
								...
								<div class="single-product margin-top">
                                    <div class="product-img">
                                        <a href="#">
                                            <img src="resources/img/products/11.jpg" alt="Product Title" />
                                            <img class="secondary-image" alt="Product Title" src="resources/img/products/12.jpg">
                                        </a>
                                    </div>
                                    <div class="product-dsc">
						...
						<div id="tab-carousel-2" class="owl-carousel product-slider owl-theme">
							<div class="col-xs-12">
								<div class="single-product">
                                    <div class="product-img">
                                        <a href="#">
                                            <img src="resources/img/products/12.jpg" alt="Product Title" />
                                            <img class="secondary-image" alt="Product Title" src="resources/img/products/11.jpg">
                                        </a>
                                    </div>
                                    <div class="product-dsc">
                                        <h3><a href="#">Product Title</a></h3>
							...
							<div class="col-xs-12">
								<div class="single-product">
                                    <div class="product-img">
                                        ...
                                        <a href="#">
                                            <img src="resources/img/products/8.jpg" alt="Product Title" />
                                            <img class="secondary-image" alt="Product Title" src="resources/img/products/7.jpg">
                                        </a>
                                    </div>
                                    <div class="product-dsc">
                                        <h3><a href="#">Product Title</a></h3>
							...
							<div class="col-xs-12">
								...
								<div class="single-product margin-top">
                                    <div class="product-img">
                                        ...
                                        <a href="#">
                                            <img src="resources/img/products/14.jpg" alt="Product Title" />
                                            <img class="secondary-image" alt="Product Title" src="resources/img/products/13.jpg">
                                        </a>
                                    </div>
                                    <div class="product-dsc">
                                        <h3><a href="#">Product Title</a></h3>
							...
							<div class="col-xs-12">
								<div class="single-product">
                                    <div class="product-img">
                                        ...
                                        <a href="#">
                                            <img src="resources/img/products/11.jpg" alt="Product Title" />
                                            <img class="secondary-image" alt="Product Title" src="resources/img/products/15.jpg">
                                        </a>
                                    </div>
                                    <div class="product-dsc">
                                        <h3><a href="#">Product Title</a></h3>
							...
							<div class="col-xs-12">
								<div class="single-product">
                                    <div class="product-img">
                                        ...
                                        <a href="#">
                                            <img src="resources/img/products/10.jpg" alt="Product Title" />
                                            <img class="secondary-image" alt="Product Title" src="resources/img/products/9.jpg">
                                        </a>
                                    </div>
                                    <div class="product-dsc">
                                        <h3><a href="#">Product Title</a></h3>
							...
							<div class="col-xs-12">
								<div class="single-product">
                                    <div class="product-img">
                                        ...
                                        <a href="#">
                                            <img src="resources/img/products/6.jpg" alt="Product Title" />
                                            <img class="secondary-image" alt="Product Title" src="resources/img/products/7.jpg">
                                        </a>
                                    </div>
                                    <div class="product-dsc">
								...
								<div class="single-product margin-top">
                                    <div class="product-img">
                                        <a href="#">
                                            <img src="resources/img/products/4.jpg" alt="Product Title" />
                                            <img class="secondary-image" alt="Product Title" src="resources/img/products/5.jpg">
                                        </a>
                                    </div>
                                    <div class="product-dsc">
                                        <h3><a href="#">Product Title</a></h3>
							...
							<div class="col-xs-12">
								...
								<div class="single-product margin-top">
                                    <div class="product-img">
                                        ...
                                        <a href="#">
                                            <img src="resources/img/products/13.jpg" alt="Product Title" />
                                            <img class="secondary-image" alt="Product Title" src="resources/img/products/15.jpg">
                                        </a>
                                    </div>
                                    <div class="product-dsc">
                            ...
                            <div id="testimonials" class="re-owl-carousel2 owl-carousel product-slider owl-theme">
                                <div class="single-testimonial">
                                    ...
                                    <div class="testimonial-img">
                                        <a href="#"><img src="resources/img/testimonial/1.png" alt="Title" /></a>
                                ...
                                <div class="single-testimonial">
                                    ...
                                    <div class="testimonial-img">
                                        <a href="#"><img src="resources/img/testimonial/2.png" alt="Title" /></a>
                                        <h4><a href="#">Raymond Morales</a></h4>
                                        <span>chairman</span>
                                    </div>
                                </div>
                                ...
                                <div class="single-testimonial">
                                    ...
                                    <div class="testimonial-img">
                                        <a href="#"><img src="resources/img/testimonial/3.png" alt="Title" /></a>
                                        <h4><a href="#">Raymond Morales</a></h4>
                                        <span>chairman</span>
                                    </div>
                                </div>
				...
				<div class="row">
					<div id="blog" class="owl-carousel product-slider owl-theme re-blog">
						<div class="col-xs-12">
							<div class="blog-container-inner">
                                <div class="post-thumb">
                                    <a href="#"><img class="attachment-blog-list wp-post-image" alt="blog-2" src="resources/img/blog/111.jpg"></a>
                                </div>
						...
						<div class="col-xs-12">
							<div class="blog-container-inner">
                                <div class="post-thumb">
                                    <a href="#"><img class="attachment-blog-list wp-post-image" alt="blog-2" src="resources/img/blog/222.jpg"></a>
                                </div>
                                <div class="visual-inner">
                                    <h2 class="blog-title">
                                        <a href="#"> 75 of Ralph Laurenӳ</a>
						...
						<div class="col-xs-12">
							<div class="blog-container-inner">
                                <div class="post-thumb">
                                    <a href="#"><img class="attachment-blog-list wp-post-image" alt="blog-2" src="resources/img/blog/333.jpg"></a>
                                </div>
                                <div class="visual-inner">
                                    <h2 class="blog-title">
                                        <a href="#"> 75 of Ralph Laurenӳ</a>
													...
													<div class="quick-image">
														<div class="single-quick-image tab-content text-center">
															<div class="tab-pane  fade in active" id="sin-pro-1">
																<img src="resources/img/quick-view/10.jpg" alt="" />
															</div>
														...
														<div class="quick-thumb">
															<div class="nav nav-tabs">
																<ul>
																	<li><a data-toggle="tab" href="#sin-pro-1"> <img src="resources/img/quick-view/10.jpg" alt="quick view" /> </a></li>
																	<li><a data-toggle="tab" href="#sin-pro-2"> <img src="resources/img/quick-view/10.jpg" alt="quick view" /> </a></li>
																	<li><a data-toggle="tab" href="#sin-pro-3"> <img src="resources/img/quick-view/10.jpg" alt="quick view" /> </a></li>
																	<li><a data-toggle="tab" href="#sin-pro-4"> <img src="resources/img/quick-view/10.jpg" alt="quick view" /> </a></li>
																</ul>
															</div>
														</div>
													</div>							
												...
												<div class="col-xs-12 col-sm-5">
													<div class="quick-image">
														...
														<div class="quick-thumb">
															<div class="nav nav-tabs">
																<ul>
																	<li><a data-toggle="tab" href="#sin-pro-5"> <img src="resources/img/quick-view/10.jpg" alt="quick view" /> </a></li>
																	<li><a data-toggle="tab" href="#sin-pro-6"> <img src="resources/img/quick-view/10.jpg" alt="quick view" /> </a></li>
																	<li><a data-toggle="tab" href="#sin-pro-7"> <img src="resources/img/quick-view/10.jpg" alt="quick view" /> </a></li>
																	<li><a data-toggle="tab" href="#sin-pro-8"> <img src="resources/img/quick-view/10.jpg" alt="quick view" /> </a></li>
																</ul>
															</div>
														</div>
													</div>							
							...
							<div id="brand-logo" class="re-owl-carousel21 owl-carousel product-slider owl-theme">
								<div class="col-xs-12">
									<div class="single-brand">
										<a href="#"><img src="resources/img/brand/1.png" alt="" /></a>
									</div>
								</div>
								<div class="col-xs-12">
									<div class="single-brand">
										<a href="#"><img src="resources/img/brand/2.png" alt="" /></a>
									</div>
								</div>
								<div class="col-xs-12">
									<div class="single-brand">
										<a href="#"><img src="resources/img/brand/3.png" alt="" /></a>
									</div>
								</div>
								<div class="col-xs-12">
									<div class="single-brand">
										<a href="#"><img src="resources/img/brand/4.png" alt="" /></a>
									</div>
								</div>
								<div class="col-xs-12">
									<div class="single-brand">
										<a href="#"><img src="resources/img/brand/5.png" alt="" /></a>
									</div>
								</div>
								<div class="col-xs-12">
									<div class="single-brand">
										<a href="#"><img src="resources/img/brand/6.png" alt="" /></a>
									</div>
								</div>
								<div class="col-xs-12">
									<div class="single-brand">
       ...
       <!-- service section end -->
        ...
        <!-- Img Zoom js -->
		<script src="resources/js/img-zoom/jquery.simpleLens.min.js"></script>
		<!-- meanmenu js -->
